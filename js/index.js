$(function(){
	...
	function b1(){
		...
		window.onscroll=function(){
			...
			if(ch+scrolltop>=floor0Arr[0]&&ch+scrolltop<=floor0Arr[11]+600){
				if(sflag){
					sflag=false;				
	...
	b5();
	function b5(){
		var fzxb_xxk=$(".fzxb_xxk")[0];
		var fli_t=$("li",fzxb_xxk);
		var xxk_ab=$(".xxk_ab");
        // console.log(xxk_ab)
		xxk_ab[0].style.display="block";

		for (var i = 0; i < fli_t.length; i++) {
			fli_t[i].index=i;
			fli_t[i].onmouseover=function(){
				for (var j = 0; j < xxk_ab.length; j++) {
					fli_t[j].style.border="0";
				xxk_ab[j].style.display="none";
			   };
			   fli_t[this.index].style.borderTop="2px solid #C81623";
               fli_t[this.index].style.borderLeft="1px solid #C81623";
               fli_t[this.index].style.borderRight="1px solid #C81623";
               fli_t[this.index].style.borderBottom="1px solid white";
			  xxk_ab[this.index].style.display="block";
			}
	...
	b6();
	function b6(){
		var grmz_t2=$(".grmz_t2")[0];
		var fli_t=$("li",grmz_t2);
		var xxk_box=$(".xxk_box");
		xxk_box[0].style.display="block";
		for (var i = 0; i < fli_t.length; i++) {
			fli_t[i].index=i;
			fli_t[i].onmouseover=function(){
				for (var j = 0; j < xxk_box.length; j++) {
				xxk_box[j].style.display="none";
				fli_t[j].style.border="0";
			   };
			    fli_t[this.index].style.borderTop="2px solid #C81623";
               fli_t[this.index].style.borderLeft="1px solid #C81623";
               fli_t[this.index].style.borderRight="1px solid #C81623";
               fli_t[this.index].style.borderBottom="1px solid white";
			  xxk_box[this.index].style.display="block";
			}
	...
	b7();
	function b7(){
		var grmz_t2=$(".sjtx_t2")[0];
		var fli_t=$("li",grmz_t2);
		var xxk_box=$(".sjtx_xxkbox");
		xxk_box[0].style.display="block";
		for (var i = 0; i < fli_t.length; i++) {
			fli_t[i].index=i;
			fli_t[i].onmouseover=function(){
	...
	b8();
	function b8(){
		var grmz_t2=$(".jydq_t2")[0];
		var fli_t=$("li",grmz_t2);
		var xxk_box=$(".jydq_xxkbox");
	...
	b9();
	function b9(){
		var grmz_t2=$(".dnsm_t2")[0];
		var fli_t=$("li",grmz_t2);
		var xxk_box=$(".dnsm_xxkbox");
		console.log(xxk_box)
		xxk_box[0].style.display="block";
		for (var i = 0; i < fli_t.length; i++) {
			fli_t[i].index=i;
	...
	c1();
	function c1(){
		var grmz_t2=$(".ydjs_t2")[0];
		var fli_t=$("li",grmz_t2);
		var xxk_box=$(".ydjs_box");
	...
	c2();
	function c2(){
		var grmz_t2=$(".jjsh_t2")[0];
		var fli_t=$("li",grmz_t2);
		var xxk_box=$(".jjsh_box");
	...
	c3();
	function c3(){
		var grmz_t2=$(".mywj_t2")[0];
		var fli_t=$("li",grmz_t2);
		var xxk_box=$(".mywj_box");
	...
	c4();
	function c4(){
		var grmz_t2=$(".spbj_t2")[0];
		var fli_t=$("li",grmz_t2);
		var xxk_box=$(".spbj_box");
	...
	c5();
	function c5(){
		var grmz_t2=$(".tsyx_t2")[0];
		var fli_t=$("li",grmz_t2);
		var xxk_box=$(".tsyx_box");
	...
	c6();
	function c6(){
		var grmz_t2=$(".zcyp_t2")[0];
		var fli_t=$("li",grmz_t2);
		var xxk_box=$(".zcyp_xxkbox");
		 ...
		 var ydw=$(".ycdh")[0];
  		...
  		for (var i = 0; i < ones.length; i++) {
  		  ...
  		  ones[i].onmouseover=function(){
  		    animate(zs[this.index],{left:-65})
  		  }
  		  ones[i].onmouseout=function(){
  		    for (var j = 0; j < ones.length; j++) {
  		      animate(zs[j],{left:35})
  		    };
  		  }
  		};
 		var obj=document.body.scrollTop?document.body:document.documentElement;
  		ones[6].onclick=function(){
